			...
			<div className="details">
				<div className="details_block">
					<div className="details_router">
						<span className="details_span" onClick={() => navigate("/home")}>
							Главная /{" "}
						</span>
						<span className="details_span" onClick={() => navigate("/")}>
							{" "}
							Рестораны
						</span>
				...
				<div className="info">
					<p className="details_info">
						...
						завораживающим видом на Петербург с высоты птичьего полета – перед
						вами как на ладони купол Исаакиевского собора, шпиль Петропавловской
						крепости, бесконечная череда крыш и небо. Панорамные окна выходят
						сразу на три стороны, а в теплое время года прямо на крыше работает
						летняя терраса. Свидание двух романтиков, деловой обед с коллегами,
						тихий семейный ужин – повод окружить себя красотой может быть
						разным. Настоящую гармонию вкуса, комфорта и эстетического
						наслаждения вы найдете у нас – в «Парусах на крыше».
					</p>
				</div>

				<div className="details_food">
					<h2 style={{ color: "#A07D50" }}>
						Популярные блюда в меню ресторана «Паруса на крыше»
					</h2>
					<div className="food_block">
						<div className="food_card">
							<img
								...
								alt=""
							/>
							<h5 style={{ color: "#373E44", textAlign: "center" }}>
								Салат с хрустящими баклажанами и сливочным сыром
							</h5>
						</div>
						<div className="food_card">
							<img
					...
					<button className="food_btn">Показать больше</button>
				</div>
			</div>
			<Menu />
		</div>
