      ...
      <Box className="reviews">
        <Box className="reviewsCrd">
          ...
          <Typography className="reviewsText">
            ...
            harum reprehenderit at accusantium eveniet atque facilis maxime
            consectetur, sit, numquam vitae quidem rerum eos perferendis alias
            mollitia nostrum architecto placeat.
          </Typography>
        </Box>
      </Box>
    </>
